  ...
  return (
    <Box
      style={{
        ...
        background: `linear-gradient(180deg, ${COLORS.neutral.bgPrimary} 0%, ${COLORS.neutral.bgSecondary} 48%, var(--mantine-color-gray-0) 100%)`,
      }}
    >
        ...
        <Stack gap="xl">
          <Stack gap="md" ta="center" maw={640} mx="auto">
            ...
            <Text size="lg" c="dimmed" lh={1.55}>
              HomeEdge helps you compare monthly cost, long-term wealth,
              equity growth, and break-even timing before you decide whether
              to rent or buy.
            </Text>
